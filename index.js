...
const questions = [
  ...
  },
  {
    ...
    name: "confirmUsage",
    message:
      "Would you like to give instructions on how to use your application?",
  },
  {
  ...
  },
  {
    ...
    message:
      "Would you like for other developers to be able to contribute to your project?",
  },
  {
    ...
    name: "contribution",
    message:
      "Please let other developers know how they can contribute to your project.",
...
function writeToFile(fileName, data) {
  fs.writeFile(fileName, data, (error) => {
    if (error) {
      return console.log(
        "Sorry there was an error with creating your README.md" + error
      );
    }
  });
}
...
async function init() {
  ...
  try {
    ...
    console.log(
      "Thank you for using Professional README Generator your userREADME.md is now begin generated! ",
      userAnswers
    );
